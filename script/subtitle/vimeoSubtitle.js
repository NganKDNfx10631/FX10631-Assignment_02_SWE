   ...
   sendMessagePromise(request).then(res => {
      if(res.code === 200)
      {
         getData(res.data).then(() => {
            vimeoSubtitle = new subtitleObserver("#funix-text .ytp-caption-segment");
            vimeoSubtitle.initData(vi, eng);
            showConfirm();
         });
      }
   });
...
function initVisibleSubtitle() {
   let container = $('<div class="vp-telecine" id="funix-text" dir="ltr" tabindex="0" aria-live="assertive" lang="en" draggable="true" data-layer="4" style="touch-action: none;text-align: left;overflow: hidden;left: 5%;width: 90%;height: auto;bottom: 2%;"> <span class="captions-text" style="overflow-wrap: normal; display: block;bottom: 2%;position: absolute;"> <span class="caption-visual-line" style="display: block;"> <span class="ytp-caption-segment" style="word-wrap: break-word;width: 100%;display: inline-block;white-space: pre-wrap;background: rgba(8, 8, 8, 0.5);-webkit-box-decoration-break: clone;border-radius: 5.20556px;font-size: 2.5vw;color: rgb(255, 255, 255);fill: rgb(255, 255, 255);font-family: &quot;YouTube Noto&quot;, Roboto, &quot;Arial Unicode Ms&quot;, Arial, Helvetica, Verdana, &quot;PT Sans Caption&quot;, sans-serif;"> </span> </span> </span> </div>');
   setTimeout(() => {
      $(".vp-video-wrapper")
      .append(container);
   }, 1000);
